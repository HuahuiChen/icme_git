...
source_folder = '/home/chh/data/VOCdevkit/results/VOC2007/final_results/test_part_full/result/'
ground_folder = '/home/chh/data/VOCdevkit/results/VOC2007/final_results/test_part_full/gt/'
fig_folder = '/home/chh/data/VOCdevkit/results/VOC2007/final_results/test_part_full/fig/'
...
def match(lst, ratio, ground):
	def overlap(prop, ground):
		...
		if (v_p != v_g): return 0
		return (min(e_p, e_g)-max(l_p, l_g))/(max(e_p, e_g)-min(l_p, l_g) + 0.0000001)

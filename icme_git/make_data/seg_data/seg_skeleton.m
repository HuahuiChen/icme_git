...
image_height = 300;
save_filedir = '../map_data/seg_skeleton';
...
save_image_train_dir = fullfile(save_filedir, 'seg_train_cs');
save_image_test_dir = fullfile(save_filedir, 'seg_test_cs');
...
for i = 1 : size(filename, 1)
    ...
    if exist(fullfile(source_image_train_dir, [name '.png']))
        ...
        for seg_cnt = 1 : seg_num - 1
            ...
            % i = 669, name = 225-L, 1~1000, 100~1100 contains no label
            % i = 670...
...
%                 error('error for label index end')
            ...
            imwrite(image(:, seg_start : seg_end, :), ...
                [save_image_train_dir, '/', name, '_', num2str(seg_start, '%04d'),...
